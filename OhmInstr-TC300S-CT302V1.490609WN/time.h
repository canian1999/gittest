...
/*
 * RCS $Revision: 122727 $
 * Checkin $Date: 2007-01-19 10:59:33 +0000 (Fri, 19 Jan 2007) $
...
extern _ARMABI double difftime(time_t /*time1*/, time_t /*time0*/);
    ...
    */
extern _ARMABI time_t mktime(struct tm * /*timeptr*/);
   /*
...
extern _ARMABI char *asctime(const struct tm * /*timeptr*/);
#ifndef __STRICT_ANSI__
extern _ARMABI char *asctime_r(const struct tm * /*timeptr*/,
    ...
    */
extern _ARMABI char *ctime(const time_t * /*timer*/);
   /*
    ...
    */
extern _ARMABI struct tm *gmtime(const time_t * /*timer*/);
   /*
    ...
    */
extern _ARMABI struct tm *localtime(const time_t * /*timer*/);
#ifndef __STRICT_ANSI__
